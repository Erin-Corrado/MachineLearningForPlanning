...
the rewards $J_k \left(s_i, \pi_k \left(s_i \right) \right)$ for a fixed arbitrary policy, and then 
...
%TODO(jake): explain the many ways to solve a POMDP and some current research.
...
%TODO(jake) give a few applications of POMDPs
